...
POST   /v1/auth/login                      # may return a 2FA challenge instead of tokens
POST   /v1/auth/refresh
POST   /v1/auth/logout
GET    /v1/auth/me
POST   /v1/auth/forgot-password
POST   /v1/auth/reset-password
POST   /v1/auth/2fa/setup                  # requires auth
POST   /v1/auth/2fa/verify-setup           # requires auth
POST   /v1/auth/2fa/login/verify           # no auth; redeems a login challenge_token
POST   /v1/auth/2fa/login/resend           # no auth; redeems a login challenge_token
